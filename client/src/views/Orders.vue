                ...
                <td class="col-items">
                  <details class="items-details">
                    ...
                    <div class="items-dropdown">
                      <!-- The server merges duplicate SKUs per order, so sku is unique within order.items here -->
  ...
  setup() {
    ...
    const loadOrders = async () => {
      try {
        ...
        // Restock orders are internal restocking requests, not customer orders,
        // so they are always shown regardless of the global filter bar selections.
